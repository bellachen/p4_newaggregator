...
$sub_folder = 'itc250/webdevelopmentkit/wn18';//If app installed in subfolder, place here.  name of folder, no leading or trailing forward or backslash
...
define('SUPPORT_EMAIL', 'hchen045@seattlecentral.edu'); # Email of site support
define('PREFIX', 'wn18_'); #Adds uniqueness to DB table names.  Limits hackability, naming collisions.  In WordPress the prefix is wp_
